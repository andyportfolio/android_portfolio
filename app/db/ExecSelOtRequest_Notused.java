 ...
 */
public class ExecSelOtRequest_Notused extends AsyncTask<String, Void, String> {
    ...
    private final String TAG = "ExecSelOtRequest_Notused";

    private Context context;

    private ProgressDialog pd;

    public ExecSelOtRequest_Notused(Context context) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        Log.d(TAG, "step: ExecSelOtRequest_Notused");
