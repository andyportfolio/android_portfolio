 ...
 */
public class ListViewMyNotifyAdapter extends BaseAdapter {
    private final String TAG = "ListViewMyNotifyAdapter"; //this.getClass().getName();
    ...
    public ListViewMyNotifyAdapter(FragmentActivity activity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (req_type){
            case "01":
                //수신 매수
                listViewHolder.imageView.setImageResource(R.drawable.ic_send_white_24dp);
                break;

            case "02":
                //수신 답장
                listViewHolder.imageView.setImageResource(R.drawable.ic_reply_white_24dp);
                break;

            case "03":
                //수신 확인
                listViewHolder.imageView.setImageResource(R.drawable.ic_reply_all_white_24dp);
                break;
