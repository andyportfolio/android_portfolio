 ...
 */
public class NotifyRootFragment extends Fragment {
    private static final String TAG = "NotifyRootFragment";
    private static NotifyRootFragment instance = null;
    ...
    public NotifyRootFragment() {
        // Required empty public constructor
    }

    public static NotifyRootFragment newInstance(int rnum, int origin_rnum, String req_type) {

        if (instance == null) {
            instance = new NotifyRootFragment();
        }
