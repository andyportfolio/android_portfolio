 ...
 */
public class ListViewOtResponseAdapter extends BaseAdapter {

    private static String TAG = "ListViewOtResponseAdapter";
    private ArrayList<ListViewOtResponseItem> listViewOtResponseItems = new ArrayList<ListViewOtResponseItem>();
    ...
    //listViewOtResponseAdapter 의 btn_replyBtn.setOnClickListener을 처리하기 위하여
    //Listner-1. 인터페이스 정의
    ...
    public ListViewOtResponseAdapter(PopupListner popupListner) {

        //Listner-3.인터페이스를 통해서 parent의 refernece를 받아온다
        //사실상 MyItemActivity가 넘어온 것으로
        //MyItemActivity가 PopupListner를 상속받았기때문에
    ...
    @Override
    public int getCount() {
        return listViewOtResponseItems.size();
    }
    ...
    public Object getItem(int position) {
        return listViewOtResponseItems.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.listview_ot_responseitem, parent, false);
        }
        ...
        ListViewOtResponseItem listViewResponseItem = listViewOtResponseItems.get(position);
    ...
    public void addItem(String regtime, String regcompany, String content, String replycnt, String reponse_rnum) {
        ...
        ListViewOtResponseItem item = new ListViewOtResponseItem();
        ...
        listViewOtResponseItems.add(item);

    }

    //clear data
    public void clearData() {
        listViewOtResponseItems.clear();
    }
